...
// Verifica si se ha proporcionado un ID de inmueble
if (isset($_GET['id'])) {
    $idInmueble = $_GET['id'];

    // Consulta el inmueble con el ID proporcionado
    $consulta = "SELECT * FROM TBLInmueble WHERE IdInmueble = $idInmueble";
    $resultado = mysqli_query($con, $consulta);

    // Verifica si se encontró el inmueble
...
<head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.min.js" integrity="sha384-kmK5I3Fo5w5f5krZ5R5u1Cqz5pRbAUO9RkPrqer2fFt5f5z5D5F5f5f5f5f5f5f5" crossorigin="anonymous"></script>
