                ...
                <tbody>
                    <?php while ($fila = $resultado->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td><?= $fila['rol'] ?></td>
                            <td>
                                <a href="editar.php?id=<?= $fila['id'] ?>" class="btn btn-success">
                                    <i class="bi bi-pencil-square"></i>
                                </a>
                            </td>
                            <td>
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal<?= $fila['id'] ?>">
